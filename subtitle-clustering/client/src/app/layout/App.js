...
import StepperContainer from "features/steps/StepperContainer";
...
class App extends Component {
    render() {
        ...
        const stepProps= {
          steps:steps, fluid:true,pointing:true,size:"tiny",sticky:true
        };

        const tabs = [
            {name : "home", label : "Home", component : null},
            {name : "msc", icon:"film", label : "Movie Subtitle Clustering", component : StepperContainer,componentProps:stepProps}
        ];
          ...
          <StickyContainer>
            <div className="App">
                ...
                <Container id="main-container">
                    <TabBarContainer id="main-menu" tabs={tabs} icon='labeled' stackable pointing secondary fluid widths={2} size="large" />
                </Container>
